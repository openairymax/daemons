...
AIRY_API int mem_service_adapter_create(airy_svc_t *out_service, const airy_svc_config_t *config);

AIRY_API int mem_service_adapter_wrap(airy_svc_t *out_service, mem_service_t *mem_svc,
