...
#define AIRY_ERR_SERVICE_BASE 3000

#define TOOL_ERR_BASE (AIRY_ERR_SERVICE_BASE + 100)
...
#define AIRY_ERR_TOOL_NOT_FOUND TOOL_ERR_NOT_FOUND
#define AIRY_ERR_TOOL_VALIDATION TOOL_ERR_INVALID_PARAMS

#define AIRY_ERR_TOOL_EXEC_FAIL TOOL_ERR_EXEC_FAILED

#define AIRY_ERR_TOOL_TIMEOUT TOOL_ERR_TIMEOUT
