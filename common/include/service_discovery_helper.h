...
#define AIRY_RT_DAEMON_COMMON_SERVICE_DISCOVERY_HELPER_H

#include "../../../commons/utils/sd/include/service_discovery_helper.h"

#endif /* AIRY_RT_DAEMON_COMMON_SERVICE_DISCOVERY_HELPER_H */
