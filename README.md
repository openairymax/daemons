...
| **Resilience & safety** | `daemon_security.c`, `daemon_oom.c`, `input_validator.c` (circuit breaker, api_recovery, log_sanitizer, ipc_backpressure authoritative implementations live in `commons/`) |
