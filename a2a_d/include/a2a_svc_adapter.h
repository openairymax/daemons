...
#define AIRY_RT_DAEMON_A2A_SVC_ADAPTER_H
...
AIRY_API int a2a_service_adapter_init(airy_svc_t service);
AIRY_API int a2a_service_adapter_start(airy_svc_t service);
AIRY_API int a2a_service_adapter_stop(airy_svc_t service, bool force);
AIRY_API void a2a_service_adapter_destroy(airy_svc_t service);
AIRY_API int a2a_service_adapter_healthcheck(airy_svc_t service);

AIRY_API const airy_svc_interface_t *a2a_service_adapter_get_interface(void);

#ifdef __cplusplus
}
#endif

#endif /* AIRY_RT_DAEMON_A2A_SVC_ADAPTER_H */
